...
ALTER TABLE campaigns ADD COLUMN IF NOT EXISTS preview_text TEXT NOT NULL DEFAULT '';
ALTER TABLE automation_steps ADD COLUMN IF NOT EXISTS preview_text TEXT NOT NULL DEFAULT '';

ALTER TABLE templates ADD COLUMN IF NOT EXISTS design JSONB;
ALTER TABLE campaigns ADD COLUMN IF NOT EXISTS design JSONB;
ALTER TABLE automation_steps ADD COLUMN IF NOT EXISTS design JSONB;
...
CREATE INDEX IF NOT EXISTS idx_media_workspace ON media (workspace_id, id DESC);
